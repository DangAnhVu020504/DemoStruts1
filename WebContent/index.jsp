...
<body>
    <div class="header">
        ...
        <form action="searchUsers.do" method="get" class="header-search-form">
    ...
    <div class="container index-container">
        ...
        <br><br><br><br><br><br><br><br>
            <!-- Hiển thị tiêu đề "Kết quả tìm kiếm" ngay từ đầu -->
            <h3>Kết quả tìm kiếm</h3>
            <!-- Chỉ hiển thị danh sách hoặc hình "not found" khi có tìm kiếm -->
            <c:if test="${not empty param.minFollowing || not empty param.minFollowers}">
                ...
                <c:if test="${empty searchResults}">
                    <img src="${pageContext.request.contextPath}/image/12753479.png" alt="Not Found" class="not-found-img"/>
                </c:if>
            </c:if>
        </div>
    </div>
